  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
        ...
        <Link to="/categories/new" className="px-6 py-2.5 bg-bcr-blue text-white font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-bcr-blue-dark transition-colors shadow-md shadow-bcr-blue/20 shrink-0">
          ...
          <tbody>
            {categories.map((cat) => (
              <tr key={cat.id} className="border-b border-gray-50 hover:bg-gray-50/50">
                ...
                <td className="p-4 text-gray-600">{cat.count}</td>
                <td className="p-4 text-right flex justify-end gap-2 min-w-[100px]">
                  <Link to={`/categories/edit/${cat.id}`} className="text-blue-500 hover:bg-blue-50 p-2 rounded-lg transition-colors inline-flex">
